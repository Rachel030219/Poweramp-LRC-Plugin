    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!LrcWindow.initialized) {
            ...
            if (statusIntent != null && trackIntent != null) {
                val bundle = trackIntent.getBundleExtra(PowerampAPI.EXTRA_TRACK)?.apply {
                    putBoolean(PowerampAPI.EXTRA_PAUSED, statusIntent.getBooleanExtra(PowerampAPI.EXTRA_PAUSED, true))
